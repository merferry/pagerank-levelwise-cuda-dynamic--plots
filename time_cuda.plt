...
set style line 3 linetype 4 linewidth 3 pointtype 7 pointsize 1 dashtype 2
...
plot [500:10000] 'data/arabic-2005.csv' \
  ...
  ''  using 1:2  title 'Incremental nvGraph' linestyle 3 with linespoints
...
plot 2 t 'Dynamic Monolithic'  linestyle 1 with linespoints, \
     ...
     2 t 'Incremental nvGraph' linestyle 3 with linespoints
