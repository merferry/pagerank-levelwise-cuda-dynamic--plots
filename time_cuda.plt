...
plot [500:10000] 'time-all/arabic-2005.csv' \
      using 1:9  title 'DT_{MLPR}'       linestyle 1 with linespoints, \
  ''  using 1:15 title 'DT_{LWPR}'       linestyle 2 with linespoints, \
  ''  using 1:17 title 'DT_{HYPR (GPU)}' linestyle 3 with linespoints, \
  ''  using 1:2  title 'ND_{NVPR}'       linestyle 4 with linespoints
...
plot 2 t 'DT_{MLPR}'       linestyle 1 with linespoints, \
     ...
     2 t 'DT_{HYPR (GPU)}' linestyle 3 with linespoints, \
     2 t 'ND_{NVPR}'       linestyle 4 with linespoints
